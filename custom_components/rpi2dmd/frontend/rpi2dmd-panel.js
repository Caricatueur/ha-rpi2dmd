...
const RPI_EXACT_HERO_CSS = `
  ...
  .hero-copy{display:flex;flex-direction:column;justify-content:center;min-width:0}.hero-art{position:relative;display:flex;align-items:center;justify-content:center;min-width:0;padding:10px 0;background:radial-gradient(ellipse at center,rgba(14,70,112,.34) 0%,rgba(10,30,55,.16) 48%,transparent 76%)}.hero-art:before{content:"";position:absolute;inset:4% 0;background:linear-gradient(90deg,rgba(8,11,18,.72),transparent 22%,transparent 78%,rgba(8,11,18,.54));pointer-events:none}.hero-banner{position:relative;display:block;width:100%;height:auto;max-width:100%;max-height:100%;object-fit:contain;object-position:center;background:none;opacity:.96;mix-blend-mode:screen;filter:saturate(1.04) contrast(1.02);-webkit-mask-image:linear-gradient(90deg,transparent 0%,#000 4%,#000 96%,transparent 100%),linear-gradient(0deg,transparent 0%,#000 3%,#000 97%,transparent 100%);mask-image:linear-gradient(90deg,transparent 0%,#000 4%,#000 96%,transparent 100%),linear-gradient(0deg,transparent 0%,#000 3%,#000 97%,transparent 100%);-webkit-mask-composite:source-in;mask-composite:intersect;z-index:1}
