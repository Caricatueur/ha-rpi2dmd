...
const RPI_POLISH_CSS = `
  *{box-sizing:border-box}:host{--rpi-blue:#03a9f4;--rpi-cyan:#22d3ee;--rpi-purple:#a855f7}
  ...
  .hero:after{content:"";position:absolute;inset:0;background:radial-gradient(circle at 84% 35%,rgba(34,211,238,.28),transparent 33%),linear-gradient(90deg,rgba(0,0,0,.2),transparent 60%);z-index:0;pointer-events:none}
  ...
  .hero-copy{display:flex;flex-direction:column;justify-content:center;min-width:0}.hero-art{display:flex;align-items:center;justify-content:center;min-width:0;padding:10px 0}.hero-banner{display:block;width:100%;height:auto;max-height:100%;object-fit:contain;object-position:center}
  ...
  @media(max-width:700px){main{padding:16px 12px 34px}.hero{min-height:0}.hero-content{display:flex;align-items:stretch;flex-direction:column;gap:8px;min-height:0;padding:24px 20px}.hero-copy{gap:0}.hero-art{width:100%;padding:12px 0 0}.hero-banner{width:100%;height:auto;max-height:none;object-fit:contain}.hero-meta{width:100%;align-items:stretch;flex-direction:column}.device{width:100%;justify-content:space-between}.device select{flex:1;min-width:0}.item,.schedule-row,.category-card{align-items:flex-start;flex-direction:column}.actions{width:100%}nav{padding-top:13px}}
`;
